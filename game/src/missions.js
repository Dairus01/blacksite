...
export const TRAINING_HINTS={
 MOVE:'W/A/S/D OR ARROW KEYS / LEFT TOUCH STICK',
 LOOK:'MOVE MOUSE (CLICK GAME IF NEEDED) / DRAG RIGHT SIDE',
 AIM:'HOLD RIGHT MOUSE BUTTON (RMB) / HOLD AIM',
 FIRE:'HOLD LEFT MOUSE BUTTON / HOLD FIRE',
 RELOAD:'PRESS R / TAP RLD',
 'SWITCH WEAPON':'PRESS Q OR 1-6 FOR AN OWNED GUN / TAP SWAP',
 SPRINT:'HOLD SHIFT WHILE MOVING / TAP RUN AND MOVE',
 CROUCH:'PRESS C / TAP LOW',
 JUMP:'PRESS SPACE / TAP JUMP',
 INTERACT:'PRESS E NEAR A TERMINAL / TAP USE',
 GRENADE:'PRESS G / TAP FRAG',
 MEDKIT:'PRESS H / TAP HEAL',
 'MAP / OBJECTIVE':'PRESS M / TAP MAP; CLOSE WITH M OR ESC',
 PAUSE:'PRESS ESC / TAP MENU (CLOSE THE MAP FIRST)'
};
