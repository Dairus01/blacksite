...
export function buildMissionArena(T,scene,id){
 ...
 return {world,extraction,extractionPosition:extraction.position,blocked,lineBlocked,floorHeightAt,stair:{...STAIR_SPEC,x:stairX,z:stairZ},spawns:{player:[0,20],enemy:candidates[0],enemies:candidates},cachePositions:[[-10,0,5],[10,0,-5],[0,0,-15]],activateExtraction(){light.intensity=15;},resetExtraction(){light.intensity=0;}};
}
