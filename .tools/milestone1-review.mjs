...
assert.ok(afterReload.reserveAmmo < 150, 'reload must consume reserve ammunition');
...
await traversal.waitForFunction(() => window.__GAME__.elevation >= 0.36 && window.__GAME__.grounded, null, { timeout: 5_000 });
...
assert.ok(stairState.elevation >= 0.36, 'player must traverse onto the staircase');
